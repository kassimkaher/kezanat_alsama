...
import 'package:ramadan/src/main_app/quran/pages/parts/quran_list_juzu.dart';
...
class QuranPage extends HookWidget {
  ...
  String? getLastAyaNumberReaded(QuranStateLoaded state) {
    ...
    if (page == null || page.ayahs == null) {
      return "${juzu.data!.juzuPages.first.realPageNumber} ---- ${state.info.continuQuranModel!.pageNumber!}";
    }
    final aya =
