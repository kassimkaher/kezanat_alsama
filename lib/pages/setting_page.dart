...
import 'package:ramadan/utils/routers.dart';
                          ...
                          InkWell(
                            ...
                            child: AnimatedContainer(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  color: (state.setting!.isDarkMode) == 0
                                      ? theme.primaryColor
                                      : Colors.transparent),
                              child: Text(
                                "تلقائي",
                                style: theme.textTheme.titleMedium!.copyWith(
                                    color: (state.setting!.isDarkMode) == 0
                                        ? Colors.white
                                        : theme.disabledColor,
                                    fontSize: (state.setting!.isDarkMode) == 0
                                        ? 16
                                        : 14),
                              ),
                            ),
                          ...
                          InkWell(
                            ...
                            child: AnimatedContainer(
                              ...
                              decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(
                                      kDefaultBorderRadius),
                                  color: (state.setting!.isDarkMode) == 2
                                      ? theme.primaryColor
                                      : Colors.transparent),
                              child: Text(
                                "الداكن",
                                style: theme.textTheme.titleMedium!.copyWith(
                                    color: (state.setting!.isDarkMode) == 2
                                        ? Colors.white
                                        : theme.disabledColor,
                                    fontSize: (state.setting!.isDarkMode) == 2
                                        ? 16
                                        : 14),
                              ),
                            ),
                          ...
                          InkWell(
                            ...
                            child: AnimatedContainer(
                              ...
                              decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(
                                      kDefaultBorderRadius),
                                  color: (state.setting!.isDarkMode) == 1
                                      ? theme.primaryColor
                                      : Colors.transparent),
                              child: Text(
                                "فاتح",
                                style: theme.textTheme.titleMedium!.copyWith(
                                    color: (state.setting!.isDarkMode) == 1
                                        ? Colors.white
                                        : theme.disabledColor,
                                    fontSize: (state.setting!.isDarkMode) == 1
                                        ? 16
                                        : 14),
                              ),
                            ),
                          ...
                          InkWell(
                            ...
                            child: AnimatedContainer(
                              ...
                              decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(
                                      kDefaultBorderRadius),
                                  color: (state.setting!.enableNotification)
                                      ? theme.primaryColor
                                      : Colors.transparent),
                              child: Text(
                                "تفعيل",
                                style: theme.textTheme.titleMedium!.copyWith(
                                    color: (state.setting!.enableNotification)
                                        ...
                                        : theme.disabledColor,
                                    fontSize:
                                        (state.setting!.enableNotification)
                                            ? 16
                                            : 14),
                              ),
                            ),
              ...
              RCard(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    const SizedBox(width: 10),
                    Text(
                      state.setting?.selectCity?.nameAr ?? "",
                      style: theme.textTheme.titleSmall,
                    ),
                    const Spacer(),
                    JBButton(
                ...
                child: RCard(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      const SizedBox(width: 10),
                      const Text("تسبيح الزهراء عليها السلام"),
                    ],
                  ),
                ),
              ),
