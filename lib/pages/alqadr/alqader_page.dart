...
import 'package:ramadan/pages/alqadr/salat_day.dart';
import 'package:ramadan/pages/alqadr/salat_page.dart';
                                  ...
                                  ZyaraDisplay(
                                    data: zyaratCubit
                                        ...
                                        state
                                            ...
                                            .first
                                            .index!],
                                    index: state.alqadrInfo.selectDayDetails!
                                        .zyaratData!.dataList!.first.index!,
                                  ),
                                ),
                              );
                            },
          ...
          if (data.index == null) {
            ...
            Navigator.push(
              ...
              to(
                DuaDisplay(
                  data:
                      zyaratCubit.state.info.ramadanDuaModel!.dua![data.index!],
                  index: data.index!,
                ),
              ),
            );
